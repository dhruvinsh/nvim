...
gs.setup({
  ...
  on_attach = function(bufnr)
    ...
    map({ "n", "v" }, "[h", function() gs.nav_hunk("prev") end, { desc = "Jump to previous hunk" })
    map({ "n", "v" }, "]h", function() gs.nav_hunk("next") end, { desc = "Jump to next hunk" })
    map({ "n", "v" }, "[H", function() gs.nav_hunk("last") end, { desc = "Jump to previous hunk" })
    map({ "n", "v" }, "]H", function() gs.nav_hunk("first") end, { desc = "Jump to next hunk" })
